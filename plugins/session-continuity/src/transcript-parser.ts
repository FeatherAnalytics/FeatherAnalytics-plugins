 ...
 * @param branch - Optional git branch name for metadata
 * @returns Markdown string suitable for writing to a handoff file
 */
export function generateAutoHandoff(summary: TranscriptSummary, sessionName: string, branch?: string): string {
